...
namespace memory_blocks
{
    ...
    {
        public static int holesIndex = Form1.num_holes;
        public static int processesIndex = Form1.num_process;
        public static int mem_size = Form1.mem_size;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Form3 form = new Form3(ref history_list, ref segment_list, ref hole_list);
            form.ShowDialog();
        }
